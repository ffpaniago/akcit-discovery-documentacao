---
title: "manipulating-the-dom-with-refs.md"
source: https://react.dev/learn/manipulating-the-dom-with-refs.md
captured_at: 2026-09-06T13:01:53.594Z
---
...
Another solution is to **pass a function to the `ref` attribute.** This is called a [`ref` callback.](reference/react-dom/components/common.md) React will call your ref callback with the DOM node when it's time to set the ref, and call the cleanup function returned from the callback when it's time to clear it. This lets you maintain your own array or a [Map](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map), and access any ref by its index or some kind of ID.
...
In this example, `itemsRef` doesn't hold a single DOM node. Instead, it holds a [Map](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Map) from item ID to a DOM node. ([Refs can hold any values!](learn/referencing-values-with-refs.md)) The [`ref` callback](reference/react-dom/components/common.md) on every list item takes care to update the Map:
...
Read more about [how this helps find bugs](reference/react/strictmode.md) in callback refs.
