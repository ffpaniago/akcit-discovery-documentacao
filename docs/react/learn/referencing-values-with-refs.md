---
title: "referencing-values-with-refs.md"
source: https://react.dev/learn/referencing-values-with-refs.md
captured_at: 2026-09-06T13:01:52.567Z
---
...
In this example, after you press "Send", there is a small delay before the message is shown. Type "hello", press Send, and then quickly edit the input again. Despite your edits, the alert would still show "hello" (which was the value of state [at the time](learn/state-as-a-snapshot.md) the button was clicked).
