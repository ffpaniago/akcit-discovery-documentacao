---
title: "rendering-lists.md"
source: https://react.dev/learn/rendering-lists.md
captured_at: 2026-09-06T13:01:37.550Z
---
...
The short [`<>...</>` Fragment](reference/react/fragment.md) syntax won't let you pass a key, so you need to either group them into a single `<div>`, or use the slightly longer and [more explicit `<Fragment>` syntax:](reference/react/fragment.md)
