---
title: "responding-to-events.md"
source: https://react.dev/learn/responding-to-events.md
captured_at: 2026-09-06T13:01:40.656Z
---
...
Built-in components like `<button>` and `<div>` only support [browser event names](reference/react-dom/components/common.md) like `onClick`. However, when you're building your own components, you can name their event handler props any way that you like.
