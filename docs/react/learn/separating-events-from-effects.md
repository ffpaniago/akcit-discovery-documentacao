---
title: "separating-events-from-effects.md"
source: https://react.dev/learn/separating-events-from-effects.md
captured_at: 2026-09-06T13:01:56.375Z
---
...
Let's say you've already implemented the code for them, but you're not sure where to put it. Should you use event handlers or Effects? Every time you need to answer this question, consider [*why* the code needs to run.](learn/synchronizing-with-effects.md)
...
With this code, you can be sure that there is always an active connection to the currently selected chat server, *regardless* of the specific interactions performed by the user. Whether the user has only opened your app, selected a different room, or navigated to another screen and back, your Effect ensures that the component will *remain synchronized* with the currently selected room, and will [re-connect whenever it's necessary.](learn/lifecycle-of-reactive-effects.md)
...
- **Logic inside Effects is *reactive.*** If your Effect reads a reactive value, [you have to specify it as a dependency.](learn/lifecycle-of-reactive-effects.md) Then, if a re-render causes that value to change, React will re-run your Effect's logic with the new value.
...
However, `theme` is a reactive value (it can change as a result of re-rendering), and [every reactive value read by an Effect must be declared as its dependency.](learn/lifecycle-of-reactive-effects.md) Now you have to specify `theme` as a dependency of your Effect:
