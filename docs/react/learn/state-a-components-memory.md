---
title: "state-a-components-memory.md"
source: https://react.dev/learn/state-a-components-memory.md
captured_at: 2026-09-06T13:01:41.862Z
---
...
*Hooks* are special functions that are only available while React is [rendering](learn/render-and-commit.md) (which we'll get into in more detail on the next page). They let you "hook into" different React features.
...
If your linter is [configured for React](learn/editor-setup.md), you should see a lint error when you make a mistake like this. If you don't see an error when you try the faulty code locally, you need to set up linting for your project.
