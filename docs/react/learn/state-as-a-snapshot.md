---
title: "state-as-a-snapshot.md"
source: https://react.dev/learn/state-as-a-snapshot.md
captured_at: 2026-09-06T13:01:43.275Z
---
...
You might think of your user interface as changing directly in response to the user event like a click. In React, it works a little differently from this mental model. On the previous page, you saw that [setting state requests a re-render](learn/render-and-commit.md) from React. This means that for an interface to react to the event, you need to *update the state*.
...
["Rendering"](learn/render-and-commit.md) means that React is calling your component, which is a function. The JSX you return from that function is like a snapshot of the UI in time. Its props, event handlers, and local variables were all calculated **using its state at the time of the render.**
