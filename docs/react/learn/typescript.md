...
captured_at: 2026-09-06T13:01:26.666Z
---
...
* [TypeScript with React Components](learn/typescript.md)
* [Examples of typing with Hooks](learn/typescript.md)
* [Common types from `@types/react`](learn/typescript.md)
* [Further learning locations](learn/typescript.md)

</YouWillLearn>

## Installation {/*installation*/}

All [production-grade React frameworks](learn/creating-a-react-app.md) offer support for using TypeScript. Follow the framework specific guide for installation:
...
Taking the [`MyButton` component](learn.md) from the [Quick Start](learn.md) guide, we can add a type describing the `title` for the button:
...
Or, as recommended in [Principles for structuring state](learn/choosing-the-state-structure.md), you can group related state as an object and describe the different possibilities via object types:
