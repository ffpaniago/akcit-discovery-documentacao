---
title: "your-first-component.md"
source: https://react.dev/learn/your-first-component.md
captured_at: 2026-09-06T13:01:32.632Z
---
...
The snippet above is [very slow and causes bugs.](learn/preserving-and-resetting-state.md) Instead, define every component at the top level:
...
Still, many websites only use React to [add interactivity to existing HTML pages.](learn/add-react-to-an-existing-project.md) They have many root components instead of a single one for the entire page. You can use as much—or as little—React as you need.
