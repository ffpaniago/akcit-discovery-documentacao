---
title: "preserve-manual-memoization.md"
source: https://react.dev/reference/eslint-plugin-react-hooks/lints/preserve-manual-memoization.md
captured_at: 2026-09-06T13:03:13.457Z
---


<Intro>

Validates that existing manual memoization is preserved by the compiler. React Compiler will only compile components and hooks if its inference [matches or exceeds the existing manual memoization](learn/react-compiler/introduction.md).
