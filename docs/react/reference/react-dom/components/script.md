---
title: "script.md"
source: https://react.dev/reference/react-dom/components/script.md
captured_at: 2026-09-06T13:02:36.080Z
---
...
`<script>` supports all [common element props.](reference/react-dom/components/common.md)
