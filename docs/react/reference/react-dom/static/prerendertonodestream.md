---
title: "prerenderToNodeStream.md"
source: https://react.dev/reference/react-dom/static/prerenderToNodeStream.md
captured_at: 2026-09-06T13:02:55.648Z
---
...
* **optional** `options`: An object with static generation options.
  ...
  * **optional** `onError`: A callback that fires whenever there is a server error, whether [recoverable](reference/react-dom/server/rendertopipeablestream.md) or [not.](reference/react-dom/server/rendertopipeablestream.md) By default, this only calls `console.error`. If you override it to [log crash reports,](reference/react-dom/server/rendertopipeablestream.md) make sure that you still call `console.error`. You can also use it to [adjust the status code](reference/react-dom/server/rendertopipeablestream.md) before the shell is emitted.
...
- If rendering fails, the Promise will be rejected. [Use this to output a fallback shell.](reference/react-dom/server/rendertopipeablestream.md)
