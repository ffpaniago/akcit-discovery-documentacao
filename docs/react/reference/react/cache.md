---
title: "cache.md"
source: https://react.dev/reference/react/cache.md
captured_at: 2026-09-06T13:02:19.341Z
---
...
You should use [`memo`](reference/reference/react/memo.md) to prevent a component re-rendering if its props are unchanged.
