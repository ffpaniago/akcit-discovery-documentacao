---
title: "captureOwnerStack.md"
source: https://react.dev/reference/react/captureOwnerStack.md
captured_at: 2026-09-06T13:02:21.093Z
---
...
- React error handlers ([React Root options](reference/react-dom/client/createroot.md) `onCaughtError`, `onRecoverableError`, and `onUncaughtError`)
...
The Owner Stack is different from the Component Stack available in React error handlers like [`errorInfo.componentStack` in `onUncaughtError`](reference/react-dom/client/hydrateroot.md).
