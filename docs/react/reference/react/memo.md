---
title: "memo.md"
source: https://react.dev/reference/react/memo.md
captured_at: 2026-09-06T13:02:23.710Z
---
...
Optimizing with `memo`  is only valuable when your component re-renders often with the same exact props, and its re-rendering logic is expensive. If there is no perceptible lag when your component re-renders, `memo` is unnecessary. Keep in mind that `memo` is completely useless if the props passed to your component are *always different,* such as if you pass an object or a plain function defined during rendering. This is why you will often need [`useMemo`](reference/react/usememo.md) and [`useCallback`](reference/react/usecallback.md) together with `memo`.
...
When you need to pass a function to memoized component, either declare it outside your component so that it never changes, or [`useCallback`](reference/react/usecallback.md) to cache its definition between re-renders.
