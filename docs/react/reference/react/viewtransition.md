---
title: "ViewTransition.md"
source: https://react.dev/reference/react/ViewTransition.md
captured_at: 2026-09-06T13:02:17.004Z
---
...
Like any Transition, React waits for data and new CSS (`<link rel="stylesheet" precedence="...">`) before running the animation. In addition to this, ViewTransitions also wait up to 500ms for new fonts to load before starting the animation to avoid them flickering in later. For the same reason, an image wrapped in ViewTransition will wait for the image to load. See examples of [waiting for a font](reference/react/suspense.md) and [waiting for an image](reference/react/suspense.md) on the Suspense page.
