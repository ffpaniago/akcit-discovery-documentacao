...
captured_at: 2026-09-06T13:03:25.512Z
---
...
* Server Functions should be called in a [Transition](reference/react/usetransition.md). Server Functions passed to [`<form action>`](reference/react-dom/components/form.md) or [`formAction`](reference/react-dom/components/input.md) will automatically be called in a transition.
...
See [experimental_taintUniqueValue](reference/react/experimental-taintuniquevalue.md) and [experimental_taintObjectReference](reference/react/experimental-taintobjectreference.md).
...
Supported serializable return values are the same as [serializable props](reference/rsc/use-client.md) for a boundary Client Component.
